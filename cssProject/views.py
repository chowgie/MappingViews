...
def CCMS_Objectives(request):
    return HttpResponse("1. Be employed and demonstrate professionalism, competence and passion in solving contemporary computing problems by developing or utilizing innovative IT solutions; 2. Embark in lifelong learning or research to attune to the continuous innovation in the IT industry in order to adapt to the changing demands of the gloval market; and 3. Exhibit leadership and teamwork, and commitment to their respective lcoal or global organizations.");